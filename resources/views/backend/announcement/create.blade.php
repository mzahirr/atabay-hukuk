        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-green">
                    ...
                    <span class="caption-subject bold"> Duyuru oluştur</span>
                </div>
            </div>
            <div class="form">
                <form role="form" action="{{route('announcements.store')}}" method="POST">
                    {{csrf_field()}}
                    <div class="form-body">
                        <div class="row">
                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        ...
                                        <textarea rows="8" name="announcement" class="form-control"
                                                  id="announcement">{{old('announcement')}}</textarea>
                                        ...
                                        <textarea rows="8" name="announcementEN" class="form-control"
                                                  id="announcementEN">{{old('announcementEN')}}</textarea>
