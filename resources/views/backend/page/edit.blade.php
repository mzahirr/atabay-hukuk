        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-green">
                    ...
                    <span class="caption-subject bold"> Sayfa düzenle</span>
                </div>
            </div>
            <div class="form">
                                        ...
                                        <div class="tab-pane active" id="portlet_tab1">
                                            ...
                                            <div class="form-group form-md-line-input form-md-floating-label has-success">
                                                <input type="text" id="title" class="form-control" name="title"
                                                       value="{{$page->getTranslation('tr')->first()->title ?? ''}}">
                                            ...
                                            <div class="form-group">
                                                <textarea rows="8" name="body" class="form-control"
                                                          id="body"
                                                          title="body">{{$page->getTranslation('tr')->first()->body ?? ''}}</textarea>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="portlet_tab2">
                                            <div class="form-group form-md-line-input form-md-floating-label has-success">
                                                <input type="text" id="titleEN" class="form-control" name="titleEN"
                                                       value="{{$page->getTranslation('en')->first()->title ?? ''}}">
                                            ...
                                            <div class="form-group">
                                                <textarea rows="8" name="bodyEN" class="form-control"
                                                          id="bodyEN"
                                                          title="bodyEN">{{$page->getTranslation('en')->first()->body ?? ''}}</textarea>
                                            </div>
                                        </div>
